...
void stcMuVariable(){
  ...
  file[2] = TFile::Open("outputMu/crab_TT_TuneCUETP8M1_13TeV-powheg-pythia8_0830_highptMuon.root");
  file[3] = TFile::Open("outputMu/crab_TT_TuneCUETP8M1_13TeV-powheg-pythia8_0830_customizeTrackerMuon.root");
