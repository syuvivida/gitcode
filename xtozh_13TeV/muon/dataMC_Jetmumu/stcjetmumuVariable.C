...
void stcjetmumuVariable(){

  TFile *file[6];

  file[0] = TFile::Open("outputJetmumu/DYJetsToLL_M-50_HT-100to200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_jetmumuVariable.root");
  file[1] = TFile::Open("outputJetmumu/DYJetsToLL_M-50_HT-200to400_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_jetmumuVariable.root");
  file[2] = TFile::Open("outputJetmumu/DYJetsToLL_M-50_HT-400to600_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_jetmumuVariable.root");
  file[3] = TFile::Open("outputJetmumu/DYJetsToLL_M-50_HT-600toInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_jetmumuVariable.root");
  file[4] = TFile::Open("outputJetmumu/crab_TT_TuneCUETP8M1_13TeV-powheg-pythia8_0830_jetmumuVariable.root");
  file[5] = TFile::Open("outputJetmumu/crab_SingleMuon-Run2015C-PromptReco-v1_jetmumuVariable.root");
  ...
  for(Int_t i = 0; i < size; i++){
    ...
    if( i == 0 ) c.Print("jetmumuVariable.pdf(");
    else if( i == size-1 ) c.Print("jetmumuVariable.pdf)");
    else c.Print("jetmumuVariable.pdf");
