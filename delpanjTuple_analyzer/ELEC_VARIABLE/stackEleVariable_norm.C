...
void stcEleVariableNorm(){
  ...
  c1->Print("norm_eleVariable1.gif");
  c2->Print("norm_eleVariable2.gif");
  c3->Print("norm_eleVariable3.gif");
  c4->Print("norm_eleVariable4.gif");
  c5->Print("norm_eleVariable5.gif");
  c6->Print("norm_eleVariable6.gif");
  c7->Print("norm_eleVariable7.gif");
...
void myPlot(TH1D* h_dy70, TH1D* h_dy100, TH1D* h_data, TH1D* h_sign){
  ...
  h_data->Scale((h_dy70->Integral(0,100) + h_dy100->Integral(0,100))/h_data->Integral(0,100));
