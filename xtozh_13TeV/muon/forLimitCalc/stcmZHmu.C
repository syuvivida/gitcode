...
void stcmZHmu(){
  ...
  file[0] = TFile::Open("outputmZHmu/DYJetsToLL_M-50_HT-100to200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_mZHmu.root");
  file[1] = TFile::Open("outputmZHmu/DYJetsToLL_M-50_HT-200to400_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_mZHmu.root");
  file[2] = TFile::Open("outputmZHmu/DYJetsToLL_M-50_HT-400to600_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_mZHmu.root");
  file[3] = TFile::Open("outputmZHmu/DYJetsToLL_M-50_HT-600toInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_mZHmu.root");
  ...
  for(Int_t i = 0; i < size; i++){
    ...
    if( i == 0 ) c.Print("mZHmu.pdf(");
    else if( i == size-1 ) c.Print("mZHmu.pdf)");
    else c.Print("mZHmu.pdf");
